...
if(strlen($_SESSION['superalogin'])=="") {   
...
<head>
    ...
    <title>Super Admin Dashboard | SRMS</title>
...
<body class="top-navbar-fixed">
                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-sm-6">
                                <h2 class="title text-white">Super Admin Dashboard</h2>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row g-4 justify-content-center">
                            ...
                            <div class="col-md-4">
                                <div class="info-card">
                                    ...
                                    <p>Monitor student progress, subject averages, and overall performance trends.</p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="info-card">
                                    ...
                                    <p>Manage classes, results, subjects, and user data with full super admin control.
                                    </p>
                                </div>
                            </div>
    ...
    $(function() {
        ...
        toastr["success"]("Welcome to Super Admin Dashboard!");
    });
    </script>
</body>
